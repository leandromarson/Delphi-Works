...
begin
  ...
  //operador if
   ...
   begin
     ShowMessage('O aluno obteve '+ FloattoStr(media) +' de média! APROVADO');
   end
   else
   begin
     ShowMessage('O aluno obteve '+ FloattoStr(media) +' de média! REPROVADO');
   end;
...
begin
  ...
  LblValor.Caption := 'Meu nome é: ' + nome + ' ' + sobrenome + ', e meu endereço é: ' + endereco
